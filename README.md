This repository was created for functional testing of consul-client, specifically to test the behavior of different `ConsulFailoverStrategy` implementations.
