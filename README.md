This repository was created for functional testing of [consul-client](https://github.com/kiwiproject/consul-client), specifically to test the behavior of different `ConsulFailoverStrategy` implementations.
